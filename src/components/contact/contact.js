        ...
        <div className='bg-[#c9dde0] justify-center'>
            <div className='flex lg:flex-row md:flex-row sm:flex-col flex-col lg:gap-32 md:gap-20 sm:gap-14 gap-14 justify-center p-20 '>
                <div className='flex-col border-[rgb(255,255,255)] bg-[rgb(114,137,143)] border-8 p-6 rounded-xl justify-center text-center'>
                    <Center>
                        <div className='w-1/2 justify-center align-middle items-center m-3' >
                            <img src='/contact_images/image_yi_xin.jpg' className='rounded-lg fit max-h-[300px]' />
                        </div>
                    </Center>
                    ...
                    <div className='mt-5 bg-[rgb(54,69,73)] rounded-xl p-10 text-white lg:w-[35vw] md:w-[35vw] sm:w-[69vw]'>
                        "Yeo Yi Xin is a final-year BSc {"("}Hons{")"} Computer Science student at the University of Nottingham Malaysia. 
                        With a strong passion for cybersecurity, machine learning, and software development, Yi Xin has made contributions to the Painterly
                        website project. Her work involved implementing cartoon and watercolor filters, devoloping the website's structure, 
                        and developing its API. Through this project, Yi Xin honed her skills in creating maintainable, 
                        well-structured websites and deepened her knowledge in image processing. Additionally, collaborating with Erin has 
                        enhanced her communication skills and time management abilities.
                    </div>
                ...
                <div className='flex-col border-[rgb(255,255,255)] bg-[rgb(114,137,143)] border-8 p-6 rounded-xl justify-center text-center'>
                    <Center>
                        <div className='w-1/2 justify-center align-middle items-center m-3' >
                            <img src='/contact_images/image_erin.jpg' className='rounded-lg max-h-[300px]' />
                        </div>
                    </Center>
